          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <!-- form -->
                <form class="form" method="POST" action="ejecutarInscripcion.php">
            ...
            <td>&nbsp;</td>
                    ...
                    <input type="hidden" class="form-control" name="id_fiesta"  value="<?=$idFiesta?>"/>
            ...
            <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td><div>
                        ...
                        <button type="submit" class="btn btn-primary btn-lg">Regístrarse</button>
                      </div></td>
                      <th></th>
                    </tr>
                  </table>
