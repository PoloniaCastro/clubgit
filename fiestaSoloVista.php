                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $resultado1 = mysqli_query( $conexion, $consulta1 ) or die ( "Algo ha ido mal en la consulta a la base de datos.");
                          ...
                          <td><a  type='submit'style='color:black;' class='btn btn-primary btn-lg' href='bloquearFiestaSoloVista.php?id_fiesta=".$columna['id_fiesta']."& id=".$columnaRp['id']."'>Bloquear</a></td></tr>  ";
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      $resultado1 = mysqli_query( $conexion, $consulta1 ) or die ( "Algo ha ido mal en la consulta a la base de datos.");
                        ...
                        <td><a  type='submit'style='color:black;' class='btn btn-primary btn-lg' href='accederFiestaSoloVista.php?id_fiesta=".$columna['id_fiesta']." & id=".$columnaRp['id']."'>Acceder</a></td>
                        </tr>  ";
