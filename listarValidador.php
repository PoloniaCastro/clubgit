...
?>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Lista de validadores</div>
            <div class="card-body">
              <div class="table-responsive">
                <!-- form -->
                <form class="form" method="GET" action="ejecutarEliminarValidador.php">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    include_once("clases/conexion.php");
                      ...
                      $consulta1= "SELECT * FROM rp where permisos=3";
                      ...
                      $resultado1 = mysqli_query( $conexion, $consulta1 ) or die ( "Algo ha ido mal en la consulta a la base de datos.");
                        ...
                        <td><a  type='submit'style='color:black;' class='btn btn-primary btn-lg' href='editarValidador.php?id=".$columna['id']." '>Editar</a></td></tr>  ";
